...
@Component({
  selector: 'app-manual-washstation',
  templateUrl: './manual-washstation.component.html',
  styleUrl: './manual-washstation.component.css'
})
export class ManualWashstationComponent {
